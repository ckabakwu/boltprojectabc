/*
  ...
  3. Changes
    - Add function to generate temporary credentials
    - Add function to validate temporary credentials
*/
...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM users WHERE email = 'admin@homemaidy.com') THEN
